...
- check_column_class:
  ...
  `[logical(1)]`  
  Whether to check that each columns has the same class in `object` and
  `expected`.
...
3.  The appropriate tblcheck grading function is called, returning any
    ...
    2.  [`grade_this_vector()`](https://rstudio.github.io/tblcheck/v0.2.1/reference/grade_this_vector.md)
