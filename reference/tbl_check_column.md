...
- check_levels:
  ...
  `[logical(1)]`  
  Whether to check that `column` and has the same [factor
...
tbl_grade_column("a")
#> <gradethis_graded: [Incorrect]
#>   Your `a` column should contain 11 values, but it has 10
#>   values. I expected your result to include the value `11`.
#> >
