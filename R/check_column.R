...
#' `expected`.
#' If the columns differ, returns a failure state and an informative message 
#' with [gradethis::fail()].
#'
...
#' @param check_class A logical indicating whether to check that `name` has 
#' the same class in `object` and `expected`.
