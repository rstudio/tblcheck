...
Sys.setenv(NO_COLORS = "FALSE")
options(max.print = 20, pillar.bold = FALSE, crayon.enabled = FALSE)
...
fake_grade_chunks <- function(
  ...
  user <- paste(knitr::knit_code$get(user), collapse = "")
