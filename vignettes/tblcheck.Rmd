...
tblcheck produces automatic feedback for [common problems in tables](#grading-tables) with `tbl_grade_table()`.
Because the columns of data frames in R are vectors, tblcheck can also provide feedback for [common problems in vectors](#grading-vectors) with `vec_grade_vector()`.
