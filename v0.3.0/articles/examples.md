...
an
exercise](https://rstudio.github.io/tblcheck/v0.3.0/articles/tblcheck.html#usage)
for use with tblcheck.)

## Create a Table

The first example repeats the example presented in the [*Get started*
article](https://rstudio.github.io/tblcheck/v0.3.0/articles/tblcheck.md).
...
for checking
vectors](https://rstudio.github.io/tblcheck/v0.3.0/articles/tblcheck.html#grading-vectors)
